...
CREATE  TABLE IF NOT EXISTS `bank`.`transaction` (
  ...
  `idAccount_sender` BIGINT(20) NULL DEFAULT NULL ,
  `idAccount_receiver` BIGINT(20) NULL DEFAULT NULL ,
  `amount` INT(11) NOT NULL ,
  `comments` VARCHAR(100) NULL DEFAULT NULL ,
  `created` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP ,
  `senderAccNum` VARCHAR(50) NULL DEFAULT NULL ,
  `receiverAccNum` VARCHAR(45) NULL DEFAULT NULL ,
  `senderName` VARCHAR(45) NULL DEFAULT NULL ,
